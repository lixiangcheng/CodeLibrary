...
public class QRcodeTest2 {
    ...
    public static void getRequest1(){
        String result =null;
        String  TOKEN=  "5YmID_SXH1PnpCRGJOSgTSV6K-cQzl5GWjfwJfid-VCZhbCzYvtmNuEwGmFiREtKRrJWigKLt4-1AYumfRwJgrI6COYWJg6cAWAPItiX_D_ZQeE0bYUdCrLwtq5Uw5IsFTOeACAYMH";
        String url =" https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token="+TOKEN;//请求接口地址
